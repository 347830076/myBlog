...
<img :src="$withBase('/assets/img/js/kuayu/k1.png')" alt="k1">
...
<img :src="$withBase('/assets/img/js/kuayu/k2.png')" alt="k2">
...
<img :src="$withBase('/assets/img/js/kuayu/k3.png')" alt="k3">
...
转载 <a herf="https://github.com/ljianshu/Blog/issues/55">https://github.com/ljianshu/Blog/issues/55</a>